...
{
    public class FacultyDevelopmentResponse
    {
         public string Event { get; set; }
        public string TitleOfTheProgram { get; set; }
        public string TrainingAttendedBy { get; set; }
        public string OrganisedBy { get; set; }
        public string Venue { get; set; }
        public string FDPSponsoredBy { get; set; }
        public string SanctionedAmount { get; set; }
        public string ParticipantsType { get; set; }
        public string NParticipants { get; set; }
        public string CoOrdinator { get; set; }
        public string CoCoordinator { get; set; }
